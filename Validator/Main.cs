...
namespace Notus.Validator
{
    public class Main : IDisposable
    {
        ...
        */
        ...
        public ulong EmptyBlockGenerationTime(ulong currentQueueTime, ulong queueTimePeriod)
        {
            /*
            ...
            while ( tmpExitMainLoop == false && NVG.Settings.NodeClosing == false && NVG.Settings.GenesisCreated == false )
            {
                ...
                */
                ...
                if (NVG.NOW.Int >= currentQueueTime)
                {
                    ...
                    {
                        NP.Info("selectedWalletId : " + selectedWalletId);
                        ...
                        while (endingTime >= NVG.NOW.Int)
                        {
                            if (txExecuted == false)
                            {
                                ulong emptyBlockGenerateTime=EmptyBlockGenerationTime(currentQueueTime, queueTimePeriod);
