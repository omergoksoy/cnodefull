...
namespace Notus.Validator
{
    public class Queue : IDisposable
    {
        ...
        public string ProcessIncomeData(string incomeData)
        {
            ...
            {
                return (
                    JsonSerializer.Deserialize<NVS.HttpRequestDetails>(NTT.GetPureText(incomeData, "poolData")) == null
                    ? "ok"
                    : "distribute"
                );
            }
        ...
        public void ReOrderNodeQueue(ulong currentQueueTime, string queueSeedStr)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                NVG.BlockMeta.Validator(peerStartingTime, NVG.Settings.Nodes.Queue[peerStartingTime].Wallet);
