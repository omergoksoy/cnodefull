...
namespace Notus.Encode
{
    ...
    public static class RLP_Sorunlu
    {
        ...
        public static string Encode(IEnumerable<string> input, NVE.InputOrOutputType returnType = NVE.InputOrOutputType.AsHex)
        {
        ...
        public static IList<string> Decode(string input, NVE.InputOrOutputType returnType = NVE.InputOrOutputType.AsHex)
        {
